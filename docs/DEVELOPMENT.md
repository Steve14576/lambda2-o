...
- **不使用蓝牙音频设备**
- 线上合规:无原声、无原画、无未成年声音、MOSS 弱化真人特征
...
### 9.2 音色素材采集
- 图恒宇:刘德华公开演唱/采访/电影干声(素材极多)
- 马兆:宁理《沉默的真相》《隐秘而伟大》干声片段
- MOSS:**不用刘琮原声**,用 TTS 原生电子音 + 滤波后处理
- 每角色准备 3 段 10 秒参考音(平静/压抑/崩溃)
- 使用 UVR5 降噪后存 `assets/voice-refs/`
- **该目录 .gitignore**,不入仓库
...
### 12.2 GitHub 开源版
- **必须**通过 env `INCLUDE_MINOR=false` 打包
- 删除所有图丫丫音频、prompt、剧情分支
- 只留图恒宇、马兆、MOSS 三成年角色
- README 明确声明:
  - AI 合成语音,与真人无关
  - 非商用同人学习项目
